...
void CheckRegNormDetector(){
  ...
  c1->cd(1);
  mul_tree->Draw("asym_usl/ppm","ErrorFlag==0");
  c1->cd(2);
  mul_tree->Draw("asym_usr/ppm","ErrorFlag==0");
  c1->cd(3);
  mul_tree->Draw("asym_usl/ppm:asym_usr/ppm","ErrorFlag==0");
  c1->cd(4);
  mul_tree->Draw("(asym_usl/ppm-asym_usr/ppm)/2","ErrorFlag==0");
  c1->cd(5);
  mul_tree->Draw("(asym_usl/ppm+asym_usr/ppm)/2","ErrorFlag==0");
  c1->cd(6);
  mul_tree->Draw("asym_usl/ppm:asym_usr/ppm",
		 "ErrorFlag==0","prof");
  ...
  // Downstream
  c1->cd(1);
  mul_tree->Draw("asym_dsl/ppm","ErrorFlag==0");
  c1->cd(2);
  mul_tree->Draw("asym_dsr/ppm","ErrorFlag==0");
  c1->cd(3);
  mul_tree->Draw("asym_dsl/ppm:asym_dsr/ppm","ErrorFlag==0");
  c1->cd(4);
  mul_tree->Draw("(asym_dsl/ppm-asym_dsr/ppm)/2","ErrorFlag==0");
  c1->cd(5);
  mul_tree->Draw("(asym_dsl/ppm+asym_dsr/ppm)/2","ErrorFlag==0");
  c1->cd(6);
  mul_tree->Draw("asym_dsl/ppm:asym_dsr/ppm","ErrorFlag==0",
  ...
  c1->cd(1);
  mul_tree->Draw("cor_usl/ppm","ErrorFlag==0");
  c1->cd(2);
  mul_tree->Draw("cor_usr/ppm","ErrorFlag==0");
  c1->cd(3);
  mul_tree->Draw("cor_usl/ppm:cor_usr/ppm","ErrorFlag==0");
  c1->cd(4);
  mul_tree->Draw("cor_usl/ppm:cor_usr/ppm>>hcoruslr","ErrorFlag==0",
		 "prof");
  gPad->Update();
  ...
  // Downstream
  c1->cd(1);
  mul_tree->Draw("cor_dsl/ppm","ErrorFlag==0");
  c1->cd(2);
  mul_tree->Draw("cor_dsr/ppm","ErrorFlag==0");
  c1->cd(3);
  mul_tree->Draw("cor_dsl/ppm:cor_dsr/ppm","ErrorFlag==0");
  c1->cd(4);
  mul_tree->Draw("cor_dsl/ppm:cor_dsr/ppm>>hcordslr","ErrorFlag==0",
		 "prof");
  gPad->Update();
  ...
  pad_buff=c1->cd(6);
  mul_tree->Draw("(cor_dsl/ppm-cor_dsr/ppm)/2:pattern_number","ErrorFlag==0","COL");
