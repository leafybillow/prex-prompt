...
void CheckPairSAM(vector<TString> vDet, TString tag,TString user_cut);
...
void CheckPairSAM(){
  ...
  CheckPairSAM(vSAMU,"cor_sam2648","ErrorFlag==0");  // FIXME : It should be device_Error_Code  (Maybe ... )
  CheckPairSAM(vSAMV,"cor_sam1537","ErrorFlag==0");
